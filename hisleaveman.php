                ...
                <form method="post" id="fid">
                    ...
                    <table align="center" cellpadding="8px" cellspacing="2px" style="width: 100%" >                       
                        ...
                        <?php
                            ...
                            $qr_sel="SELECT empid,l_balance,l_branch,l_date,l_type, IF(status=5,'Sanctioned',if(status=2,'Declined','Pending')) as Status from leave_approve WHERE l_branch='$branch' ORDER by la_id desc ";
//                            echo $qr_sel;
